...
class IndexController extends AdminController
{
    public function index(){
        ...
        if ($role !== 'user' && $role !== 'china_viewer' && $role !== 'china_admin' && $role !== 'office_eng' && $role !== 'viewer_eng' && !in_array($role, parent::COURIERS_ARR)) {
        ...
        elseif (in_array($role, parent::COURIERS_ARR)) {
