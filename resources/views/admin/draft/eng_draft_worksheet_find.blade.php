		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					@if (session('status') === 'Activate error!')
					...
					<a class="btn btn-primary btn-move" href="{{ route('showEngDraftWorksheet') }}">Add row</a>
								...
								<tbody>
									...
									<tr>
										...
										<td class="td-button">
											...
											<a class="btn btn-success" onclick="ConfirmActivate(event)" href="{{ url('/admin/eng-draft-activate/'.$row->id) }}">Activate</a>
