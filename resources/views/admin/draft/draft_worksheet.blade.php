						...
						<div class="table-container">
							<table class="table table-striped table-bordered">
								...
								<tbody>
									...
									@if(isset($draft_worksheet_obj))
									@foreach($draft_worksheet_obj as $row)
									...
									<tr>
										...
										<td class="td-button">
											...
											{!! Form::open(['url'=>route('deleteDraftWorksheet'),'onsubmit' => 'return ConfirmDelete()', 'class'=>'form-horizontal','method' => 'POST']) !!}
							...
							@if(isset($data))
							{{ $draft_worksheet_obj->appends($data)->links() }}
							@else
							{{ $draft_worksheet_obj->links() }}
							@endif
